...
java.util.List<String> _result = this.getCarrierPackageNamesForIntent(_arg0);
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
String[] _result = this.getMergedSubscriberIds();
reply.writeNoException();
reply.writeStringArray(_result);
return true;
}
...
/**
     ...
     */
@Override public void dial(String number) throws android.os.RemoteException
{
...
/**
     ...
     */
@Override public void call(String callingPackage, String number) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public boolean supplyPin(String pin) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     * @return whether the operation was a success.
     */
@Override public boolean supplyPinForSubscriber(int subId, String pin) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     * @return whether the operation was a success.
     */
@Override public boolean supplyPuk(String puk, String pin) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     * @return whether the operation was a success.
     */
@Override public boolean supplyPukForSubscriber(int subId, String puk, String pin) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     */
@Override public int[] supplyPinReportResult(String pin) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
...
/**
     ...
     *         retValue[1] = number of attempts remaining if known otherwise -1
     */
@Override public int[] supplyPinReportResultForSubscriber(int subId, String pin) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
...
/**
     ...
     *         retValue[1] = number of attempts remaining if known otherwise -1
     */
@Override public int[] supplyPukReportResult(String puk, String pin) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
...
/**
     ...
     *         retValue[1] = number of attempts remaining if known otherwise -1
     */
@Override public int[] supplyPukReportResultForSubscriber(int subId, String puk, String pin) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
...
/**
     ...
     */
@Override public boolean handlePinMmi(String dialString) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     * @return true if MMI command is executed.
     */
@Override public boolean handlePinMmiForSubscriber(int subId, String dialString) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     */
@Override public java.util.List<android.telephony.NeighboringCellInfo> getNeighboringCellInfo(String callingPkg) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     */
@Override public String getCdmaEriText() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     ...
     * @param subId user preferred subId.
     */
@Override public String getCdmaEriTextForSubscriber(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     ...
     */
@Override public boolean setVoiceMailNumber(int subId, String alphaTag, String number) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public android.telephony.IccOpenLogicalChannelResponse iccOpenLogicalChannel(String AID) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     *            the end.
     */
@Override public String iccTransmitApduLogicalChannel(int channel, int cla, int instruction, int p1, int p2, int p3, String data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     ...
     *            the end.
     */
@Override public String iccTransmitApduBasicChannel(int cla, int instruction, int p1, int p2, int p3, String data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     ...
     */
@Override public byte[] iccExchangeSimIO(int fileID, int command, int p1, int p2, int p3, String filePath) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
byte[] _result;
...
/**
     ...
     *         string.
     */
@Override public String sendEnvelopeWithStatus(String content) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     * Read one of the NV items defined in {@link} / {@code ril_nv_items.h}.
     * Used for device configuration by some CDMA operators.
     *
     * @param itemID the ID of the item to read.
     * @return the NV item as a String, or null on any failure.
     */
@Override public String nvReadItem(int itemID) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     * Write one of the NV items defined in {@link} / {@code ril_nv_items.h}.
     * Used for device configuration by some CDMA operators.
     *
     * @param itemID the ID of the item to read.
     ...
     */
@Override public boolean nvWriteItem(int itemID, String itemValue) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     */
@Override public String[] getPcscfAddress(String apnType) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String[] _result;
...
/**
     ...
     * @param subId user preferred subId.
     */
@Override public String getCdmaMdn(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     ...
     * @param subId user preferred subId.
     */
@Override public String getCdmaMin(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     ...
     */
@Override public int checkCarrierPrivilegesForPackage(String pkgname) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
/**
     ...
     */
@Override public java.util.List<String> getCarrierPackageNamesForIntent(android.content.Intent intent) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     */
@Override public boolean setLine1NumberForDisplayForSubscriber(int subId, String alphaTag, String number) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     */
@Override public String getLine1NumberForDisplay(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     ...
     * previously via {@link #}. Otherwise returns null.
     *
     ...
     *         not set.
     */
@Override public String getLine1AlphaTagForDisplay(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
@Override public String[] getMergedSubscriberIds() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String[] _result;
...
/**
     ...
     * @return true if the operation was executed correctly.
     */
@Override public boolean setOperatorBrandOverride(String brand) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     * @return true if the operation was executed correctly.
     */
@Override public boolean setRoamingOverride(java.util.List<String> gsmRoamingList, java.util.List<String> gsmNonRoamingList, java.util.List<String> cdmaRoamingList, java.util.List<String> cdmaNonRoamingList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
      ...
      */
@Override public String getDeviceId() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
/**
     ...
     * @return whether the operation was a success.
     */
public boolean supplyPinForSubscriber(int subId, String pin) throws android.os.RemoteException;
/**
     * Supply puk to unlock the SIM and set SIM pin to new pin.
     *  Blocks until a result is determined.
     * @param puk The puk to check.
...
/**
     ...
     * @return whether the operation was a success.
     */
public boolean supplyPukForSubscriber(int subId, String puk, String pin) throws android.os.RemoteException;
/**
     * Supply a pin to unlock the SIM.  Blocks until a result is determined.
     * Returns a specific success/error code.
     * @param pin The pin to check.
     ...
     *         retValue[1] = number of attempts remaining if known otherwise -1
     */
public int[] supplyPinReportResult(String pin) throws android.os.RemoteException;
/**
     * Supply a pin to unlock the SIM.  Blocks until a result is determined.
     * Returns a specific success/error code.
     * @param pin The pin to check.
     ...
     *         retValue[1] = number of attempts remaining if known otherwise -1
     */
public int[] supplyPinReportResultForSubscriber(int subId, String pin) throws android.os.RemoteException;
/**
     * Supply puk to unlock the SIM and set SIM pin to new pin.
     * Blocks until a result is determined.
     * Returns a specific success/error code
     ...
     *         retValue[1] = number of attempts remaining if known otherwise -1
     */
public int[] supplyPukReportResult(String puk, String pin) throws android.os.RemoteException;
/**
     * Supply puk to unlock the SIM and set SIM pin to new pin.
     * Blocks until a result is determined.
     * Returns a specific success/error code
     ...
     *         retValue[1] = number of attempts remaining if known otherwise -1
     */
public int[] supplyPukReportResultForSubscriber(int subId, String puk, String pin) throws android.os.RemoteException;
/**
     * Handles PIN MMI commands (PIN/PIN2/PUK/PUK2), which are initiated
     * without SEND (so <code>dial</code> is not appropriate).
     *
...
/**
     ...
     * @return true if MMI command is executed.
     */
public boolean handlePinMmiForSubscriber(int subId, String dialString) throws android.os.RemoteException;
/**
     * Toggles the radio on or off.
     */
...
/**
     * Returns the neighboring cell information of the device.
     */
public java.util.List<android.telephony.NeighboringCellInfo> getNeighboringCellInfo(String callingPkg) throws android.os.RemoteException;
...
/**
     ...
     * @param subId user preferred subId.
     */
public String getCdmaEriTextForSubscriber(int subId) throws android.os.RemoteException;
/**
     * Returns true if OTA service provisioning needs to run.
     * Only relevant on some technologies, others will always
     * return false.
...
/**
     * Sets the voicemail number for a particular subscriber.
     */
public boolean setVoiceMailNumber(int subId, String alphaTag, String number) throws android.os.RemoteException;
/**
      * Returns the unread count of voicemails
      */
...
/**
     ...
     * @return an IccOpenLogicalChannelResponse object.
     */
public android.telephony.IccOpenLogicalChannelResponse iccOpenLogicalChannel(String AID) throws android.os.RemoteException;
/**
     * Closes a previously opened logical channel to the ICC card.
     *
     * Input parameters equivalent to TS 27.007 AT+CCHC command.
...
/**
     ...
     *            the end.
     */
public String iccTransmitApduLogicalChannel(int channel, int cla, int instruction, int p1, int p2, int p3, String data) throws android.os.RemoteException;
/**
     * Transmit an APDU to the ICC card over the basic channel.
     *
     * Input parameters equivalent to TS 27.007 AT+CSIM command.
     ...
     *            the end.
     */
public String iccTransmitApduBasicChannel(int cla, int instruction, int p1, int p2, int p3, String data) throws android.os.RemoteException;
/**
     * Returns the response APDU for a command APDU sent through SIM_IO.
     *
     * @param fileID
     ...
     * @return The APDU response.
     */
public byte[] iccExchangeSimIO(int fileID, int command, int p1, int p2, int p3, String filePath) throws android.os.RemoteException;
/**
     * Send ENVELOPE to the SIM and returns the response.
     *
     ...
     *         string.
     */
public String sendEnvelopeWithStatus(String content) throws android.os.RemoteException;
/**
     ...
     * @return the NV item as a String, or null on any failure.
     */
public String nvReadItem(int itemID) throws android.os.RemoteException;
/**
     ...
     * @return true on success; false on any failure.
     */
public boolean nvWriteItem(int itemID, String itemValue) throws android.os.RemoteException;
/**
     * Update the CDMA Preferred Roaming List (PRL) in the radio NV storage.
     * Used for device configuration by some CDMA operators.
     *
...
/**
     ...
     * @param apnType the apnType, "ims" for IMS APN, "emergency" for EMERGENCY APN
     */
public String[] getPcscfAddress(String apnType) throws android.os.RemoteException;
/**
     * Set IMS registration state
     */
...
/**
     ...
     * @param subId user preferred subId.
     */
public String getCdmaMdn(int subId) throws android.os.RemoteException;
/**
     * Return MIN string for CDMA phone.
     * @param subId user preferred subId.
     */
public String getCdmaMin(int subId) throws android.os.RemoteException;
/**
     * Has the calling application been granted special privileges by the carrier.
     *
     * If any of the packages in the calling UID has carrier privileges, the
...
/**
     * Similar to above, but check for pkg whose name is pkgname.
     */
public int checkCarrierPrivilegesForPackage(String pkgname) throws android.os.RemoteException;
/**
     * Returns the package name of the carrier apps that should handle the input intent.
     *
     ...
     *         are no matching packages.
     */
public java.util.List<String> getCarrierPackageNamesForIntent(android.content.Intent intent) throws android.os.RemoteException;
/**
     * Set the line 1 phone number string and its alphatag for the current ICCID
     * for display purpose only, for example, displayed in Phone Status. It won't
     * change the actual MSISDN/MDN. To unset alphatag or number, pass in a null
     ...
     * @return true if the operation was executed correctly.
     */
public boolean setLine1NumberForDisplayForSubscriber(int subId, String alphaTag, String number) throws android.os.RemoteException;
/**
     * Returns the displayed dialing number string if it was set previously via
     ...
     * @return the displayed dialing number if set, or null if not set.
     */
public String getLine1NumberForDisplay(int subId) throws android.os.RemoteException;
/**
     * Returns the displayed alphatag of the dialing number if it was set
     ...
     *         not set.
     */
public String getLine1AlphaTagForDisplay(int subId) throws android.os.RemoteException;
public String[] getMergedSubscriberIds() throws android.os.RemoteException;
/**
     * Override the operator branding for the current ICCID.
     *
     * Once set, whenever the SIM is present in the device, the service
     ...
     * @return true if the operation was executed correctly.
     */
public boolean setOperatorBrandOverride(String brand) throws android.os.RemoteException;
/**
     * Override the roaming indicator for the current ICCID.
     *
     * Using this call, the carrier app (see #hasCarrierPrivileges) can override
     ...
     * @return true if the operation was executed correctly.
     */
public boolean setRoamingOverride(java.util.List<String> gsmRoamingList, java.util.List<String> gsmNonRoamingList, java.util.List<String> cdmaRoamingList, java.util.List<String> cdmaNonRoamingList) throws android.os.RemoteException;
/**
     * Returns the result and response from RIL for oem request
     *
     * @param oemReq the data is sent to ril.
...
/**
      ...
      *   {@link android.Manifest.permission#READ_PHONE_STATE READ_PHONE_STATE}
      */
public String getDeviceId() throws android.os.RemoteException;
}
