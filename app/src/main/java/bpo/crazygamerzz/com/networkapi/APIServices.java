...
public interface APIServices {
    ...
    @GET("getNextDump")
    Call<LoginData> getNextNumberDump(@Query("USER_EMAIL") String userEmail);

    @POST("sendUniqueGcmDeviceToken")
    @FormUrlEncoded
    Call<DeviceTokenResponse> sendDeviceTokenId(@Field("USER_EMAIL") String userEmail,@Field("DEVICE_TOKEN_ID") String deveiceTokenId);
}
